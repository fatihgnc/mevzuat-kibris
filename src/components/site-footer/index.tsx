    ...
    <footer className="mt-16 border-t border-line bg-surface-muted">
      <div className="mx-auto max-w-6xl px-4 py-10 sm:px-8 lg:px-10">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <nav aria-labelledby="footer-sosyal">
            <h2 id="footer-sosyal" className="mb-3 text-lg font-semibold text-ink">
              Sosyal medya
            </h2>
            <ul className="flex flex-col gap-2 text-base">
              <li>
                ...
                <a
                  ...
                  aria-label="Facebook"
                  title="Facebook"
                  className="inline-flex text-ink-body no-underline hover:text-accent hover:no-underline"
                >
