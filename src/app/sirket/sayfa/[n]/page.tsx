...
/**
 * Page 2 and beyond of the sirket index.
 *
 * A NOTE ON THE PATH. `/sirket/sayfa/2` is matched by this literal segment rather
 * than by `/sirket/[slug]`, because Next resolves a static segment before a dynamic
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return entityIndexMetadata('company', page);
}
...
export default async function Page({ params }: Props) {
  ...
  return <EntityIndex kind="company" page={page} />;
}
