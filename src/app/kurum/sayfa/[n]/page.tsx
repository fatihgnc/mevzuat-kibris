...
/**
 * Page 2 and beyond of the kurum index.
 *
 * A NOTE ON THE PATH. `/kurum/sayfa/2` is matched by this literal segment rather
 * than by `/kurum/[slug]`, because Next resolves a static segment before a dynamic
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return entityIndexMetadata('institution', page);
}
...
export default async function Page({ params }: Props) {
  ...
  return <EntityIndex kind="institution" page={page} />;
}
